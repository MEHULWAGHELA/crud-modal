...
import { Col, Container, Form, FormGroup, Input, Label, Row, Button, Modal, ModalHeader, ModalBody, ModalFooter } from "reactstrap"
    ...
    return (
        <Fragment>
            ...
            <Modal isOpen={modal} toggle={toggle} >
                <ModalHeader toggle={() => toggle(1)}>Modal title</ModalHeader>
                <ModalBody>
                    <form onSubmit={(e) => { submitFunction(e) }}>
                        ...
                        <Row>
                            ...
                            <Col md={6} className="imgheight">
                                ...
                                <div>
                                    <input type="file" id="profile" name="profile" onChange={mainData} />
                                </div>
                            </Col>
                            <Col md={6}>
                                <div className="my-2">
                        ...
                        <div className="text-center">
                            <button className="my-2 btn btn-secondary fs-4" onClick={toggle}>
                                Submit
                            </button>
                        </div>
                    </form>
            ...
            <header className="text-bg-dark py-4">
                <Container className="d-flex justify-content-between">
                    <h1>Employee</h1>
                    <Button className="bg-secondary fs-3" onClick={toggle}>
                        +Add
                    </Button>
                </Container>
            </header>
